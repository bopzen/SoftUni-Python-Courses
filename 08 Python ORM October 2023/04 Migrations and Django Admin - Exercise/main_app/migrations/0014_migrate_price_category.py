# Generated by Django 4.2.4 on 2023-10-24 08:35
...
def set_price(apps, schema_editor):
    ...
    for smartphone in smartphone_model.objects.all():
        smartphone_model.price = len(smartphone.brand) * MULTIPLIER
        smartphone.save()
...
def reverse_set_price_and_category(apps, schema_editor):
    smartphone_model = apps.get_model('main_app', 'Smartphone')
    smartphone_category_default = smartphone_model._meta.get_field('category').default
    for smartphone in smartphone_model.objects.all():
        smartphone.price = 0
        smartphone.category = smartphone_category_default
        smartphone.save()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(set_price_and_category, reverse_code=reverse_set_price_and_category)
    ]
